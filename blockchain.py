...
class DodoCoin:
    ...
    def __create_genesis_block(self):
        ...
        self._genesis_block = Block(index=0, transactions=[], previous_block_hash=0, difficulty_level=1, current_version=3,
    ...
    def list_pending_transactions(self):
        for transaction in self.mem_pool:
            print("***************These are the pending transactions**********")
            print(transaction)
